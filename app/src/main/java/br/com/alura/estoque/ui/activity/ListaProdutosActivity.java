...
public class ListaProdutosActivity extends AppCompatActivity {
    ...
    private void buscaProduto() {
        repository.buscaProdutos(new ProdutoRepository.DadosCarregadosCallBack<List<Produto>>() {
            ...
            public void quandoFalha(String erro) {
                Toast.makeText(ListaProdutosActivity.this,"Não foi possivel carregar os produtos",Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void remove(int posicao, Produto produtoEscolhido) {
        repository.remove(produtoEscolhido,
                new ProdutoRepository.DadosCarregadosCallBack<Void>() {
                    ...
                    @Override
                    public void quandoFalha(String erro) {
                        Toast.makeText(ListaProdutosActivity.this,"Não foi possivel removero produto",Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void edita(int posicao, Produto produtoCriado) {
        repository.edita(produtoCriado, new ProdutoRepository.DadosCarregadosCallBack<Produto>() {
            ...
            @Override
            public void quandoFalha(String erro) {
                Toast.makeText(ListaProdutosActivity.this, "Não foi possivela editar o produto",Toast.LENGTH_SHORT).show();
            }
        });
    }
}
